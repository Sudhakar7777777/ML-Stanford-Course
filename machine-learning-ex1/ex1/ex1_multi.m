...
% Init Theta and Run Gradient Descent 
theta5 = zeros(3, 1);
[theta5, J_history5] = gradientDescentMulti(X, y, theta5, alpha, num_iters);
...
predictVals = [1, 1650, 3];

for i = 1 : size(X, 2)-1
	predictVals(i+1) = (predictVals(i+1) - mu(i)) / sigma(i);
end;

price = predictVals * theta;
...
predictVals2 = [1, 1650, 3];

price2 = predictVals2 * theta2;
